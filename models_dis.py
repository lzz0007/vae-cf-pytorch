...
class MultiVAE(nn.Module):
    ...
    def __init__(self, p_dims, q_dims=None, dropout=0.5, tau=0.1, std=0.075, kfac=7, nogb=False):
        ...
        # self.items_bow = nn.Embedding(num_items, 1000)
        # self.items_bow.weight = nn.Parameter(torch.FloatTensor(embeds_item_bow))
        # self.items_layer = nn.Linear(dfac+1000, dfac)
